namespace VictoryRestaurant.Contact.Infrastructure.Repositories;

/// <summary> <see cref="ContactMessageEntity"/> repository. </summary>
public sealed class ContactMessageEntityRepository : IContactMessageEntityRepository
{
    ...
    public ValueTask<ContactMessageEntity?> CreateAsync(
    ...
    public ValueTask<ContactMessageEntity?> UpdateAsync(
        ContactMessageEntity entity, 
        CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
